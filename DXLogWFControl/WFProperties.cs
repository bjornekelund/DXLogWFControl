...
namespace DXLog.net
{
    public partial class WFProperties : Form
    {
        ...
        public WFProperties(RadioSettings sett)
        {
            InitializeComponent();
        ...
        private void btnOK_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Invalid entry", "Waterfall control properties", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }
